...
def generate_model(weight_decay=0.0005, verbose=False):
    ...
    ---------------------------------------------------------------------------
    INPUT:
        type: the type of the model structer. It can be market (for market1501) or cuhk (for cuhk03)
...
def compile_model(model, verbose=False, *args, **kw):
    '''
